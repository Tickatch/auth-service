...
public class AuthApi {
  ...
  public ResponseEntity<LoginResponse> register(
    ...
    return ResponseEntity.status(HttpStatus.CREATED).body(LoginResponse.from(result));
  }
  ...
  public ResponseEntity<AuthInfoResponse> getMyInfo(
    ...
    return ResponseEntity.ok(AuthInfoResponse.from(info));
  }
  ...
  public ResponseEntity<CheckEmailResponse> checkEmail(
    ...
    return ResponseEntity.ok(CheckEmailResponse.of(exists));
  }
}